...
How it works
JSearch API pulls job listings every morning via GitHub Actions. Each job gets sent to GPT-4o along with my resume, it comes back with a match percentage, a recommendation, and a breakdown of matched vs missing skills. Results live in BigQuery and the Streamlit app reads from there.
